...
urlpatterns = [
   ...
   path('checkout-anonimo/', views.checkout_anonimo, name='checkout_anonimo'),
   path('process-checkout-anonimo/', views.process_checkout_anonimo, name='process_checkout_anonimo'),
